...
class AdministrativeRequests(models.Model):
    ...
    subject = models.CharField(max_length=100,help_text="Enter the subject of your Administrative Request")
    body = models.TextField(max_length=2000,help_text="Enter the description of your Administrative Request")
...
class AcademicRequests(models.Model):
    ...
    body = models.TextField(max_length=2000,help_text="Enter the description of your Academis Request")
    request_date = models.DateTimeField(auto_now_add=True,help_text="Date and time when the request was made")
